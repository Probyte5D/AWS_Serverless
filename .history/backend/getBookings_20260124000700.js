...
// Non serve dotenv e credenziali esplicite
import AWS from 'aws-sdk';

// Usa il client DynamoDB con la regione della Lambda
...
// Handler Lambda
// Questa è la funzione principale invocata da AWS Lambda quando arriva una richiesta
