...
Questa piattaforma permette di gestire le prenotazioni degli ospiti tramite un backend Node.js + AWS Lambda + API Gateway + DynamoDB e un frontend React + Redux.
Il sistema supporta la paginazione lato backend per evitare payload troppo grandi (HTTP 413).
---
